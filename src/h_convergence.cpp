...
Algoim::Real ellipsoid_surface(int n, int order)
{
...
int main(int argc, char* argv[])
{
    ...
    Algoim::Real sur2D = qd_real(4.844224110273838099214251598195914706); // Computed using ArbNumerics.jl
    Algoim::Real sur3D = qd_real(4.844224110273838099214251598195914706);
